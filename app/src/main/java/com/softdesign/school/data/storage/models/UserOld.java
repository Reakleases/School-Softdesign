...
public class UserOld {
    ...
    public UserOld(Drawable avatar, String firstName, String lastName){
        this.mImage = avatar;
        this.mFirstName = firstName;
        this.mLastName = lastName;
    }

    public UserOld(String mFirstName, String mLastName, Drawable mImage, String mVkLink, String mGitLink, int mRait) {
